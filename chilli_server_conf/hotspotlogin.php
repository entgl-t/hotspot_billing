...
$ChilliSpot="#НазваниеВашейКомпании";
$title="$ChilliSpot Вход";
$centerUsername="Логин";
$centerPassword="Пароль";
$centerLogin="Включить";
$centerPleasewait="Подождите пожалуйста.......";
$centerLogout="Отключить";
$h1Login="$ChilliSpot вход";
$h1Failed="$ChilliSpot вход провален";
$h1Loggedin="Выход из $ChilliSpot";
$h1Loggingin="Процесс входа  в $ChilliSpot";
$h1Loggedout="Вход в $ChilliSpot";
$centerdaemon="Вход может быть выполнен только через демон $ChilliSpot";
$centerencrypted="Вход только при защишенном соединении";
...
<body onLoad=\"javascript:doOnLoad($result, '$loginpath?res=popup2&uamip=$uamip&uamport=$uamport&userurl=$userurl&redirurl=$redirurl&timeleft=$timeleft','$userurldecode', '$redirurldecode', '$timeleft')\" onBlur = 'javascript:doOnBlur($result)' background = '/images/captain.jpg?random=323527528432525.24234' backgroundRepeat: 'no-repeat' backgroundPosition: 'top center'>";
...
if ($result == 2) {
    echo "
  <h1 style=\"text-align: center; color: gray ;\">$h1Failed</h1>";
    if ($reply) {
...
if ($result == 5) {
    echo "
  <h1 style=\"text-align: center;color: gray ;\">$h1Login</h1>";
}
...
if ($result == 2 || $result == 5) {
  ...
  <table border=\"0\" cellpadding=\"5\" cellspacing=\"0\" style=\"width: 217px;\">
    <tbody>
      <tr>
        <td align=\"right\" style=\"color: yellow;\">$centerUsername:</td>
        <td><input style=\"font-family: Arial\" type=\"text\" name=\"UserName\" size=\"20\" maxlength=\"128\"></td>
      </tr>
      <tr>
        <td align=\"right\" style=\"color: yellow;\">$centerPassword:</td>
...
if ($result == 1) {
  echo "
  <h1 style=\"text-align: center;color: gray;\">$h1Loggedin</h1>";
  ...
  echo "
  <center>
    <a href=\"http://$uamip:$uamport/logoff\">Отключить</a>
  </center>
</body>
</html>";
}
...
if ($result == 11) {
  echo "
  <h1 style=\"text-align: center; color: gray ;\">$h1Loggingin</h1>
  <center>
    $centerPleasewait
  </center>
</body>
...
if (($result == 3) || ($result == 13)) {
  echo "
  <h1 style=\"text-align: center; color: gray ;\">$h1Loggedout</h1>
  <center>
